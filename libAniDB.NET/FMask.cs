	...
	public partial class AniDBFile
	{
		public class FMask {
			...
			public string MaskString
			{
				get
				{
					return Mask.ToString("x").Remove(0, 6);
				}
			}
		...
		public int? AID {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.AID);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.AID, value);
			}
		}
		public int? EID {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.EID);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.EID, value);
			}
		}
		public int? GID {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.GID);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.GID, value);
			}
		}
		public int? MyListID {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.MyListID);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListID, value);
			}
		}
		public Dictionary<int, byte> OtherEpisodes {
			get {
				return (Dictionary<int, byte>)GetFMaskValue(FMask.FMaskValues.OtherEpisodes);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.OtherEpisodes, value);
			}
		}
		public short? IsDeprecated {
			get {
				return (short?)GetFMaskValue(FMask.FMaskValues.IsDeprecated);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.IsDeprecated, value);
			}
		}
		public StateMask? State {
			...
			set {
				SetFMaskValue(FMask.FMaskValues.State, value);
			}
		}
		public long? Size {
			get {
				return (long?)GetFMaskValue(FMask.FMaskValues.Size);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.Size, value);
			}
		}
		public string ED2K {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.ED2K);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.ED2K, value);
			}
		}
		public string MD5 {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.MD5);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MD5, value);
			}
		}
		public string SHA1 {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.SHA1);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.SHA1, value);
			}
		}
		public string CRC32 {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.CRC32);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.CRC32, value);
			}
		}
		public string Quality {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.Quality);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.Quality, value);
			}
		}
		public string Source {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.Source);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.Source, value);
			}
		}
		public List<string> AudioCodecs {
			get {
				return (List<string>)GetFMaskValue(FMask.FMaskValues.AudioCodecs);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.AudioCodecs, value);
			}
		}
		public List<int> AudioBitrates {
			get {
				return (List<int>)GetFMaskValue(FMask.FMaskValues.AudioBitrates);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.AudioBitrates, value);
			}
		}
		public string VideoCodec {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.VideoCodec);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.VideoCodec, value);
			}
		}
		public int? VideoBitrate {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.VideoBitrate);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.VideoBitrate, value);
			}
		}
		public string VideoResolution {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.VideoResolution);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.VideoResolution, value);
			}
		}
		public string FileType {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.FileType);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.FileType, value);
			}
		}
		public List<string> DubLanguage {
			get {
				return (List<string>)GetFMaskValue(FMask.FMaskValues.DubLanguage);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.DubLanguage, value);
			}
		}
		public List<string> SubLanguage {
			get {
				return (List<string>)GetFMaskValue(FMask.FMaskValues.SubLanguage);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.SubLanguage, value);
			}
		}
		public int? Length {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.Length);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.Length, value);
			}
		}
		public string Description {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.Description);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.Description, value);
			}
		}
		public int? AiredDate {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.AiredDate);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.AiredDate, value);
			}
		}
		public string AniDBFileName {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.AniDBFileName);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.AniDBFileName, value);
			}
		}
		public int? MyListState {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.MyListState);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListState, value);
			}
		}
		public int? MyListFileState {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.MyListFileState);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListFileState, value);
			}
		}
		public int? MyListViewed {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.MyListViewed);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListViewed, value);
			}
		}
		public int? MyListViewDate {
			get {
				return (int?)GetFMaskValue(FMask.FMaskValues.MyListViewDate);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListViewDate, value);
			}
		}
		public string MyListStorage {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.MyListStorage);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListStorage, value);
			}
		}
		public string MyListSource {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.MyListSource);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListSource, value);
			}
		}
		public string MyListOther {
			get {
				return (string)GetFMaskValue(FMask.FMaskValues.MyListOther);
			}
			set {
				SetFMaskValue(FMask.FMaskValues.MyListOther, value);
			}
		}
		#endregion
